...
public:
   ...
   */
  virtual ~MouseGrabber() { MouseGrabber::MouseGrabberPool_.remove(this); }
...
public:
  ...
  static const std::list<MouseGrabber *> &MouseGrabberPool() {
  ...
  bool isInMouseGrabberPool() const {
    return std::find(MouseGrabber::MouseGrabberPool_.begin(), MouseGrabber::MouseGrabberPool_.end(), const_cast<MouseGrabber *>(this)) != MouseGrabber::MouseGrabberPool_.end();
  }
...
private:
  ...
  static std::list<MouseGrabber *> MouseGrabberPool_;
};
