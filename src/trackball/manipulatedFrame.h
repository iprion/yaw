...
public:
  ...
  /*! Returns the \c MouseAction currently applied to this ManipulatedFrame.
   ...
   using QGLViewer::setMouseBinding(Qt::Key key, Qt::KeyboardModifier
...
public:
  ...
  QPoint pressPos() const {
    return pressPos_;
  }

  QGLViewer::MouseAction action() const {
    return action_;
  }
...
private:
  ...
  Metronom last_move_time;
  qreal mouseSpeed_;
  int delay_;
  bool isSpinning_;
  Metronom spinningTimer_;
