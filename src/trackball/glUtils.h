...
// int glProject(double objx, double objy, double objz, double *modelview, double *projection, int *viewport, double *windowCoordinateX, double *windowCoordinateY,double *windowCoordinateZ)
//   {
...
//   int glUnProject(double winx, double winy, double winz, double *modelview, double *projection, int *viewport, double *objectCoordinateX, double *objectCoordinateY,double *objectCoordinateZ)
//   {
...
//          return 0;
//       out[3]=1.0/out[3];
//       *objectCoordinateX=out[0]*out[3];
//       *objectCoordinateY=out[1]*out[3];
//       *objectCoordinateZ=out[2]*out[3];
//       return 1;
//   }
...
//   void MultiplyMatrixByVector4by4OpenGL_double(double *resultvector, const double *matrix, const double *pvector)
//   {
...
//   int glInvertMatrixf2(double *m, double *out)
//   {
//    double wtmp[4][8];
